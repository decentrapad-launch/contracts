...
import "./Interfaces/IDecentrapadNFT.sol";

contract Lock02 is ILock {
    ...
    function vestingLock(
        ...
        emit LockCreated(id, token, owner, amount, tgeDate);
        return id;
    }
    ...
    function unlock(uint256 lockId) external override validLock(lockId) {
        ...
        // check NFT owner, on basis on this handle the locks
